...
## When completed a task: Commit Protocol

When completed a task, ask user want to commit or not (Y/n), if not, skip. if yes, follow the instructions:
...
1. Generate 3 concise commit message options, starting feat, refactor, chore, or fix:
    *   **Option 1 (Normal):** Standard concise commit message, include basic things done, but no details.
